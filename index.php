  ...
  <section id="Home" class="scrollToSection">
    ...
    <div class="background-header">
      <div class="img-header">
        <img src="asset foto/asset logo sekolah/logo smk.png" alt="Logo SMK PGRI 2 Ponorogo" class="img-header" />
      </div>
      <h2>X RPL 1</h2>
      ...
      <div class="row">
        ...
        <div class="footer-col">
          ...
          <div class="social-links">
            ...
            <a href="https://www.instagram.com/official.smkpgri2ponorogo/"><i class="fab fa-instagram"></i></a>
            <a href="https://www.youtube.com/@officialsmkspgri2ponorogo"><i class="fab fa-youtube"></i></a>
          </div>
        </div>
      </div>
    </div>
